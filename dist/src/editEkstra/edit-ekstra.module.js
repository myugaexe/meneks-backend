...
exports.EditEkstraModule = void 0;
...
let EditEkstraModule = class EditEkstraModule {
};
exports.EditEkstraModule = EditEkstraModule;
exports.EditEkstraModule = EditEkstraModule = __decorate([
    (0, common_1.Module)({
        controllers: [edit_ekstra_controller_1.EditEkstraController],
        providers: [edit_ekstra_service_1.EditEkstraService],
    })
], EditEkstraModule);
//# sourceMappingURL=edit-ekstra.module.js.map